...
def get_payment_by_receipt_number(session: Session, *, receipt_number: str) -> Payment | None:
...
def update_payment_allocation(
    *, session: Session, db_payment_allocation: PaymentAllocation, payment_allocation_in: PaymentAllocationUpdate
) -> PaymentAllocation:
