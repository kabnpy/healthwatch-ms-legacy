      ...
      <div className="space-y-4">
          ...
          <table className="w-full border-collapse border-x border-t border-black text-black">
            <tbody>
              <tr className="border-b border-black">
                <th
                  scope="row"
                  className="w-[20%] p-3 text-[11px] font-black uppercase tracking-widest text-black border-r border-black text-left align-top"
                >
                  Insured
                </th>
              ...
              <tr className="border-b border-black">
                <th
                  scope="row"
                  className="w-[20%] p-3 text-[11px] font-black uppercase tracking-widest text-black border-r border-black text-left align-middle"
                >
                  Date
                </th>
                <td className="p-3 text-[11px] align-middle font-bold">
                  {yearRange}
                </td>
              </tr>
              <tr className="border-b border-black">
                ...
                <td className="p-3 text-[11px] align-middle font-bold uppercase tracking-tight">
                  {insurerName}
                </td>
              </tr>
            </tbody>
        ...
        <div className="border-x border-black bg-white overflow-hidden">
          <table className="w-full border-collapse">
            <thead>
              <tr className="border-b border-black">
                <th className="w-12 border-r border-black p-2 text-[9px] font-black uppercase text-center text-black">
                  #
                </th>
                <th className="border-r border-black p-2 text-[9px] font-black uppercase text-left text-black">
                  Class of Insurance
                </th>
                <th className="border-r border-black p-2 text-[9px] font-black uppercase text-left text-black">
                  Policy No / Period
                </th>
                <th className="w-32 p-2 text-[9px] font-black uppercase text-right text-black">
                  Amount (KSH)
                </th>
              </tr>
            </thead>
          ...
          <table className="w-full border-collapse">
            <tbody>
              <tr className="border-t border-black">
                <th
                  scope="row"
                  className="w-[80%] p-2 text-[11px] font-black uppercase tracking-widest text-black border-r border-black text-right"
                >
              ...
              {invoice.balance_due !== invoice.total_amount && (
                <tr className="border-t border-black">
                  <th
                    scope="row"
                    className="w-[80%] p-2 text-[11px] font-bold uppercase tracking-widest text-red-600 border-r border-black text-right"
                  >
                    Balance Due
                  </th>
              ...
              <tr>
                ...
                <td className="p-3 align-top">
                  <div className="grid grid-cols-2 gap-8 text-[10px] text-black">
                    <div>
                      <p className="font-bold uppercase mb-1 border-b border-black/10 pb-1 text-black">
                        MPESA Paybill
                      </p>
