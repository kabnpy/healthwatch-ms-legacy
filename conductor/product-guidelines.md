...
- **Workflow Management:** Use **Sequential Wizards** for complex, multi-step processes (e.g., New Business, Renewals).
 Break down data entry into logical, manageable steps to minimize cognitive load.
...
- **Tone:** **Direct & Clear**. Use simple, action-oriented language. Eliminate jargon where possible while maintaining professional insurance accuracy (e.g., Risk Note).
