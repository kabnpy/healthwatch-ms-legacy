...
- **Data Patterns:**
 ...
 as a 100% complete snapshot of the cover in the `RiskNote` table.
    - **Hybrid Snapshot Storage (ADR-004):** Flexible JSON schemas are used for product-specific cover data, complemented by a static template selection engine in the backend to ensure precise document layouts for different insurance classes.
